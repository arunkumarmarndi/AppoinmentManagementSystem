...
include('session.php');
$msg="";
if(strcmp($user_type,"appointer")!=0)header("location: illegal.php"); 
...
<?php
	...
	echo "Description: ".$loggedin_description."<br><br>";
?></div>
<div class="heading">
...
while($row=mysqli_fetch_array($result))
{
	...
	echo "Appointment starts from: ".$row['slot_from'].":00 hours <br>";
	...
	while($row2=mysqli_fetch_array($booking_sql))
	{
			...
			$appointmentTime=$row['nSlots']*$slot_num;
